...
Доменный слой содержит **самую важную часть приложения** - бизнес-логику и правила.
Доменный слой не должен зависеть от технических деталей реализации (база данных, веб-фреймворк, UI).
...
- [Основные компоненты](#-основные-компоненты)
  ...
  - [Доменные события (Domain Events)](./event/index.md)
...
- Интеграция с существующими системами групп
