...
- 🎯 **Анемичная модель** - простые сущности, бизнес-логика в сервисах
- 🔄 **Event-Driven** - слабая связанность через доменные события
- 📝 **Type Safety** - строгая типизация с использованием объектов-значений
...
```bash
composer require foreline/pristine
```
